...
const paragraphPauseMap = {
  descrip1: 3500, // base delay + extra delay after descrip1
  descrip2: 5000, // base delay + extra delay after descrip2
  descrip3: 6000, // base delay + extra delay after descrip3
};
